...
export default function TermsPage() {
    const termsRevisionUrl =
        'https://github.com/astraen-dev/astraen-site/commits/main/src/app/(legal)/terms/page.tsx';
    ...
    return (
        ...
        >
            <p>
                Welcome to astraen. This website is owned and operated by
                ASTRAEN (PTY) LTD (Registration No. 2025/845626/07). By
                accessing and using this website (&quot;the Site&quot;), you
            ...
            <p>
                This Site provides information about our company, our services,
                and our projects. It is intended for informational purposes
                only. You agree to use the Site in a lawful manner and not for
                any purpose that is prohibited by these Terms.
            </p>
            ...
            <p>
                ...
                ASTRAEN (PTY) LTD or its content suppliers and is protected by
                South African and international copyright laws. The ASTRAEN name
                and logo are trademarks of ASTRAEN (PTY) LTD. You may not use,
                reproduce, or distribute any content from this Site without our
            ...
            <p>
                ...
                <strong>&quot;AS AVAILABLE&quot;</strong> without any warranties
                ...
                harmful components. While we strive to provide accurate
            ...
            <p>
                To the fullest extent permitted by applicable law, ASTRAEN (PTY)
                LTD shall not be liable for any direct, indirect, incidental,
                special, or consequential damages resulting from the use or
                inability to use the Site or from any information obtained from
                the Site.
            </p>
            ...
            <p>
                ...
                GitHub, LinkedIn). These links are provided for your convenience
                only. We have no control over the content of these external
                sites and are not responsible for their content or privacy
                practices.
            </p>
