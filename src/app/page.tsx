        ...
        <>
            ...
            <Section id="hero" className="pt-24 text-center sm:pt-32">
                <Image
                    ...
                    height={120}
                    priority
                    className="mx-auto mb-8 rounded-full shadow-2xl shadow-primary-a/30"
                />
                ...
                <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
                    Boutique software development focusing on quality, performance, and
                    clean architecture. Shipping the future, one commit at a time.
                </p>
                <div className="mt-10 flex items-center justify-center gap-x-6">
                    <Link
                        href="#projects"
                        className="group flex transform items-center justify-center gap-2 rounded-full bg-gradient-to-r from-primary-a to-secondary-b px-6 py-3 font-semibold text-background-start ring-1 ring-primary-a/50 backdrop-blur-sm transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg hover:shadow-primary-b/30"
                    >
                        View Projects
            ...
            <Section id="about">
                <div className="text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-primary-b sm:text-4xl">
                        From Concept to Clean Code
                    </h2>
                    <p className="mt-4 text-lg leading-8 text-slate-300">
                        A philosophy of meticulous development across the entire product
                        lifecycle.
                    </p>
                </div>
                <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    {services.map(service => (
                        ...
                        >
                            <div
                                className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-primary-a/20 to-secondary-b/20 ring-1 ring-primary-a/30">
                                <service.icon className="h-6 w-6 text-primary-b"/>
                            </div>
            ...
            <Section id="projects">
                ...
                <div className="mt-16 grid grid-cols-1 gap-8">
                    <Link
                        href="/rainvu"
                        className="group relative block overflow-hidden rounded-2xl bg-slate-900/40 p-8 ring-1 ring-white/10 backdrop-blur-lg transition-all duration-300 hover:ring-primary-a/50 hover:shadow-2xl hover:shadow-secondary-b/10"
                    >
                        <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center">
                            ...
                            <ArrowRight
                                className="h-6 w-6 text-slate-400 transition-transform group-hover:translate-x-1 group-hover:text-primary-b sm:ml-auto"/>
                        </div>
                    </Link>
                </div>
            </Section>
